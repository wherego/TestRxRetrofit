...
import com.htf.rxretrofit.App;
import com.htf.rxretrofit.R;
import com.htf.rxretrofit.base.BaseToolbarActivity;
import com.htf.rxretrofit.iview.PictureView;
import com.htf.rxretrofit.presenter.PicturePresenter;
import com.htf.rxretrofit.utils.DeviceUtils;
import com.htf.rxretrofit.utils.IntentUtils;
import com.htf.rxretrofit.utils.ShareUtils;
import com.htf.rxretrofit.utils.ToastUtils;
...
public class PictureActivity extends BaseToolbarActivity
    ...
    public static void startActivityByActivityOptionsCompat(Activity activity, String url, String title, View view) {
        ...
        ActivityOptionsCompat activityOptionsCompat = ActivityOptionsCompat.makeScaleUpAnimation(view, view.getWidth
                () / 2, view.getHeight() / 2, view.getWidth(), view.getHeight());
        try {
